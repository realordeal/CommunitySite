package com.kr.community.member.service;
...
import com.kr.community.member.db.MemberDAO;
import com.kr.community.member.db.MemberDTO;
...
public class MemberServiceImpl implements MemberService {
	...
	public int join_member(MemberDTO member, HttpServletResponse response) throws Exception {
		...
		if (manager.check_id(member.getId()) == 1) {
			...
			out.println("<script>");
			out.println("alert('이메일 인증을 보냈습니다.');");
	...
	// 이메일 발송
	/*
	 * @Override public void send_mail(MemberDTO member, String div) throws
	 * Exception { // Mail Server 설정 String charSet = "utf-8"; String hostSMTP =
	 * "smtp.naver.com"; String hostSMTPid = "realordeal"; // 본인의 아이디 입력 String
	 * hostSMTPpwd = "kz37772382kz"; // 비밀번호 입력
	 * 
	 * // 보내는 사람 EMail, 제목, 내용 String fromEmail = "realordeal@naver.com"; // 보내는 사람
	 * eamil String fromName = "JK"; // 보내는 사람 이름 String subject = ""; // 제목 String
	 * msg = ""; // 내용
	 * 
	 * // 화원가입 메일 내용 if(div.equals("join_member")) { // 회원가입 메일 내용 subject =
	 * "Community Site 회원가입 인증 메일입니다."; msg +=
	 * "<div align='center' style='border:1px solid black; font-family:verdana'>";
	 * msg += "<h3 style='color: blue;'>"; msg += member.getId() +
	 * "님 회원가입을 환영합니다.</h3>"; msg += "<div style='font-size: 130%'>"; msg +=
	 * "하단의 인증 버튼 클릭 시 정상적으로 회원가입이 완료됩니다.</div><br/>"; msg +=
	 * "<form method='post' action='http://localhost:8090/community/member/approval_member.do'>"
	 * ; msg += "<input type='hidden' name='email' value='" + member.getEmail() +
	 * "'>"; msg += "<input type='hidden' name='approval_key' value='" +
	 * member.getApproval_key() + "'>"; msg +=
	 * "<input type='submit' value='인증'></form><br/></div>"; }else
	 * if(div.equals("find_pw")) { subject = "Community Site 임시 비밀번호 입니다."; msg +=
	 * "<div align='center' style='border:1px solid black; font-family:verdana'>";
	 * msg += "<h3 style='color: blue;'>"; msg += member.getId() +
	 * "님의 임시 비밀번호 입니다. 비밀번호를 변경하여 사용하세요.</h3>"; msg += "<p>임시 비밀번호 : "; msg +=
	 * member.getPw() + "</p></div>"; }
	 * 
	 * // 받는 사람 E-Mail 주소 String mail = member.getEmail();
	 * 
	...
	public void send_mail(MemberDTO member) throws Exception {
		...
		String hostSMTPid = "realordeal";
		String hostSMTPpwd = "kz37772382kz";

		// 보내는 사람 EMail, 제목, 내용
		String fromEmail = "realordeal@naver.com";
		String fromName = "JK";
		String subject = "";
		String msg = "";

		// 회원가입 메일 내용
		subject = "Community Site 회원가입 인증 메일입니다.";
		msg += "<div align='center' style='border:1px solid black; font-family:verdana'>";
		msg += "<h3 style='color: blue;'>";
		msg += member.getId() + "님 회원가입을 환영합니다.</h3>";
		msg += "<div style='font-size: 130%'>";
		msg += "하단의 인증 버튼 클릭 시 정상적으로 회원가입이 완료됩니다.</div><br/>";
		msg += "<form method='post' action='http://localhost:8090/community/member/approval_member.do'>";
		msg += "<input type='hidden' name='email' value='" + member.getEmail() + "'>";
	...
	@Override
	public void send_pwmail(MemberDTO member, String div) throws Exception {
		String charSet = "utf-8";
		String hostSMTP = "smtp.naver.com";
		String hostSMTPid = "realordeal";
		String hostSMTPpwd = "kz37772382kz";
		...
		if (div.equals("find_pw")) {
			subject = "Community Site 임시 비밀번호 입니다.";
			msg += "<div align='center' style='border:1px solid black; font-family:verdana'>";
			msg += "<h3 style='color: blue;'>";
